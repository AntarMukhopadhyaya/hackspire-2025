...
const FooterContent = () => {
        ...
        <div className="block">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-28 relative z-10 pt-12 pb-4 sm:py-12 lg:py-16">
            <div className="flex flex-col lg:flex-row justify-between items-center gap-4 lg:gap-12">
              ...
              <div className="flex flex-col items-center lg:items-end gap-4 sm:gap-5 lg:gap-6">
            ...
            <div className="text-center mt-6">
              <a
                href="https://befitting-lens-774.notion.site/HackSpire-25-Brand-Assets-26ec78e1cf6380c8be6de713eb579ac5?source=copy_link"
                target="_blank"
                rel="noopener noreferrer"
  ...
  return (
    <footer
      className="relative mt-20 text-white overflow-hidden"
